...
public class PostDto {
    ...
    public PostDto(String title, Long user_id, String nickname, LocalDateTime redate, Long likeNum, String language, String type, Integer level, String context, Long replyNum) {
        this.title = title;
